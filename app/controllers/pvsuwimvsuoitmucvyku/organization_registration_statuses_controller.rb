class Pvsuwimvsuoitmucvyku::OrganizationRegistrationStatusesController < Pvsuwimvsuoitmucvyku::BaseController
  def create
    ...
    if @organization_registration_status.save
      ...
      redirect_to pvsuwimvsuoitmucvyku_organization_registrations_path,
